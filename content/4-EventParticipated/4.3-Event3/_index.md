...
This meetup was my first AWS Vietnam Community event in Hanoi, and it complemented the FCAJ community days I attended earlier: the same emphasis on *build real things and share openly*, now with an AI-agent focus. Hearing practitioners reason about open-source agents, business value and production patterns helped me frame my own capstone choices — serverless automation, secrets management and cost control — in business terms, not just service names. The tea break and networking gave me the chance to talk with Community Heroes and builders directly, and the Kahoot quiz was a fun way to close the morning.